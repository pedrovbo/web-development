...
var notas = [10.0, 9.5, 9.5];
var mistura = ['Um', 2, 3, 'Quatro'];
alunos = []; //array vazio
alunos = ['Alex', 'Anna', 'João']; // array de strings
notas = [10.0, 9.5, 9.5]; //array de números decimais
mistura = ['Um', 2, 3, 'Quatro']; //array de diversos tipos de dados
